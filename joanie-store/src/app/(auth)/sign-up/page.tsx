...
export default function SignUpPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join Joanie Store for exclusive deals and faster checkout"
    >
      ...
      >
        ...
        <Link href="/sign-in" className="text-[#333333] font-semibold hover:text-[#77794E] transition-colors">
          Sign In
        </Link>
      </motion.p>
    </AuthLayout>
